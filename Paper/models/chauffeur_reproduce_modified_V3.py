...
def chauffeur_reproduce(dataset_path, transformation_name, directory_name, group_number):
    ...
    save_console_output = '/home/jagan/Desktop/Chauffeur/Results/Grp' + str(
    ...
    seed_inputs2 = os.path.join(directory_name)
    ...
    for i in label2:
        ...
        #     # print(i[0]+".jpg")
        #     filelist2.append(i[0] + ".jpg")
        print(directory_name + str(i[0]) + ".jpg")
        filelist2.append(i[0] + ".jpg")
        print(file_counter)
    ...
    filename = '/home/jagan/Desktop/Chauffeur/Results/Grp' + str(
