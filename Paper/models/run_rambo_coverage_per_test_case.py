...
def rambo_testgen_coverage(dataset_path, group_number, file_type, output_path):
    ...
    csv_filename = 'Rambo-Coverage_2-way_all_transformations_combinations' + '_Group' + str(group_number) + '.csv'
    txt_filename = 'Rambo-Coverage_2-way_all_transformations_combinations' + '_Group' + str(group_number) + '.txt'
