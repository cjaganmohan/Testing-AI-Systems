...
def rambo_guided(dataset_path):
    ...
    new_input = "/home/jagan/Desktop/Guided_Files/Rambo/Grp4/"

    model = Model("./final_model.hdf5", "./X_train_mean.npy")

    Image.warnings.simplefilter('error', Image.DecompressionBombWarning)
    seed_inputs1 = '/home/jagan/Desktop/Rambo/Baseline/' + 'Grp4'
    ...
    with open('/home/jagan/Desktop/Guided_Files/rambo_grp4_guided.csv', filewrite, 0) as csvfile:
