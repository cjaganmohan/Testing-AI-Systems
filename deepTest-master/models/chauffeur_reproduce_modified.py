...
def chauffeur_reproduce(dataset_path):
    ...
    print('Prediction results from Chauffer-model--'+ dataset_path[86:125])
    filelist1 = []
    ...
    for i in label2:
        ...
        #     sourceLocation_transformedImage = '/Users/Jagan/Desktop/chauffer-deubgging/prediction-in-batches/IndTransformations/TransformedImages_Translation_90/'+str(i[0])+".jpg"
        ...
        #     destination = '/Users/Jagan/Desktop/chauffer-deubgging/prediction-in-batches/Grp3_1767_1867/center/'
    ...
    fileName_subString = dataset_path[86:-1]
    filename = 'Chauffeur-'+fileName_subString+'.csv'
