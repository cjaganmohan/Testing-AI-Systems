...
def chauffeur_testgen_coverage(index, dataset_path,group_number):
    # Jagan changes starts
    csv_filename = 'Chauffeur-' + 'Group_' + str(group_number) + '_Baseline_' + 'Neuron-Coverage.csv'
    ...
    # seed_inputs2 = os.path.join(dataset_path, "hmb3/")
    # seed_labels2 = os.path.join(dataset_path, "hmb3/hmb3_steering.csv")
    ...
    index = int(index)
    print('index value' + str(index)) # added by Jagan

    # Jagan code changes
    filename = '/home/jagan/Desktop/chauffer-deubgging/prediction-in-batches/Results/Baseline_Coverage/' + csv_filename
    ...
    with open(filename, 'ab', 0) as csvfile:
        ...
        writer.writerow(['File name', 'cnn_threshold', 'cnn_covered_detail', 'cnn_covered_neurons' ,
              'cnn_total_neurons ' , 'lstm_threshold',  'lstm_covered_detail', 'lstm_covered_neurons', 'lstm_total_neurons', 'Predicted Steering Angle'])
        ...
        for f in filelist1:
            ...
            writer.writerow([f, str(model.threshold_cnn), str("-"), str(cnn_covered_neurons), str(cnn_total_neurons),
                             str(model.threshold_lstm), str("-"), str(lstm_covered_neurons), str(lstm_total_neurons), str(yhat)])
...
if __name__ == '__main__':
    ...
    chauffeur_testgen_coverage(args.index, args.dataset,args.group)
